...
function AboutMe() {
  ...
  return (
    <div className="w-full px-6 py-4 shadow-lg rounded-lg border border-gray-200 flex flex-col gap-4  sm:flex-row justify-between items-center">
...
function MyPassword() {
  const [isEditing, setIsEditing] = useState<boolean>(false);
  return (
    <div className="w-full px-6 py-4  shadow-lg rounded-lg border border-gray-200">
...
const Compte = () => {
  return (
    <div className="w-full h-full mt-20 px-6 pb-10 flex flex-col gap-4 md:gap-6 sm:px-10 sm:py-6 ">
