    ...
    return (
        <section className="  w-full h-svh  bg-slate-100 px-10 flex flex-col justify-center items-center pt-20">
            <div className="bg-white w-full py-4 px-4  rounded-md">
                <h2 className="text-4xl font-semibold py-6">Consultaion les cas</h2>
                <div className="bg-slate-50 w-full flex flex-col gap-5 py-6 px-6  h-[520px] overflow-hidden hover:overflow-auto rounded-md relative ">
                ...
                {isOpen && <div className={`absolute w-xl bg-white drop-shadow-xl shadow-lg rounded-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  z-[9999]`} >
