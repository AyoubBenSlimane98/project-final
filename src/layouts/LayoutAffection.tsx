...
function Header() {
    ...
    return (
        <div className="p-4 w-full sm:w-[90%]  flex items-center">
            ...
            <div className={`w-1/4 flex items-center ${curentNextStep ? "*:bg-green-400 *:text-white *:border-green-400 transform transition-colors duration-300 ease-in-out" : ""}`}>
                <div className="w-full h-0.5 bg-gray-400"></div>
                <div className="shrink-0 w-9 h-9 border-2  border-gray-400 flex items-center justify-center font-bold rounded-full text-gray-400">
                    3
                </div>
            </div>
            <div className={`w-1/4 ${Confirme ? "*:bg-green-400 *:text-white *:border-green-400 transform transition-colors duration-300 ease-in-out" : ""}`}>
                <div className="w-2/4 h-0.5 bg-gray-400"></div>
            </div>
        </div>
    )
